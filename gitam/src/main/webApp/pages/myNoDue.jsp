...
<head>
    <meta charset="utf-8">
    <title>No Due Status: Student</title>
    <meta charset="utf-8">
	 ...
	 <div class="contaniner-fluid">
        <div class="card">
            <div class="card-header">
                <div class="row">
                  <div class="col-md">
                  	 <center> <h2>Track No Due Status</h2></center>
                  </div>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md">
                        <div class="progress">
                            <div class="progress-bar ${ tracker.barBehavior} " role="progressbar"
                            aria-valuenow="${tracker.progressValue }" aria-valuemin="0" aria-valuemax="100" style="width:${tracker.progressValue }%">
                             <strong> <c:out value="${tracker.status}"></c:out> </strong>
                            </div>
                          </div> 
                    </div>
                </div>
