...
<body>
    ...
    <div class="data">
        <h3><strong>Update record for Reference ID: ${student.userRef}</strong></h3>
        <form name="sform" action="updateStudent" method="POST" onsubmit="return validateform()">
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    <input type="text" class="form-control" placeholder="Roll no." id="roll" name="roll">
                ...
                <label>Student ID</label>
                    ...
                    readonly id="sid" name="sid" placeholder="SID" value="${student.sid }" readonly >
                </div>
                <div class="form-group col-md-4">
