...
<title>Student Approval Management</title>
    ...
    <body>
        ...
        <center>
            <h2>My Assigned Subjects Management</h2>
            <br>
         </center>
        <div class="container">
            <table class="table table-striped table-bordered" id="studentList" name="studentList" >
                <thead>
                  <tr>
                    ...
                    <th scope="col">Proctor's ID</th>
                    <th scope="col">Reject This Subject</th>
                  </tr>
                </thead>
                <tbody><c:if test="${subjectsForTeachers!=null}" >
 					<c:forEach var="recomm" items="${subjectsForTeachers}"> 
                    <tr>
                        <td><c:out value="${recomm.teacherID }"/></td>
                        <td><c:out value="${recomm.subjectCode }"/></td>
                        <td><c:out value="${recomm.subjectName }"/></td>
                        <td><c:out value="${recomm.className }"/></td>
                       <td><c:out value="${recomm.classCapacity }"/></td>
                        <td><c:out value="${recomm.proctorID }"/></td>
                        <td><c:out value="${recomm.batch }"/></td>

                     
                        <td><a href="rejectSubjecct?teacherID=${recomm.teacherID }"><span class="fa-stack fa-lg">
