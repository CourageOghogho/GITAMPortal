...
<head>
    <meta charset="utf-8">
    <title>Fee Manager: Student</title>
    <meta charset="utf-8">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <center>
                            <h2>Fees And No Due Management</h2>
                        </center>
                    </div>
                </div>
            </div>
            <div class="card-body">
               <center>
                <div class="row">
                    ...
                    <div class="col-md-4">
                      <a href="myFeeStatus">  <input type="button" class="btn btn-info btn-lg" value="Check Fee Status"></a>
                    </div>
                    <div class="col-md-4">
                        <a href="initiateMyNoDue">  <input type="button" class="btn btn-warning btn-lg" value="Initiate No Due"></a>
                      </div>
                      <div class="col-md-4">
                        <a href="trackMyNoDue">  <input type="button" class="btn btn-info btn-lg" value="Track No Due"></a>
                      </div>
                </div>
               </center>
